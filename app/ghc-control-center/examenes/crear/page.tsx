...
const GREEN = "#63E546";
const BUILD_ID = "GHC-EXAM-BLUEPRINT-V4 · retorno panel Exámenes · 2026-06-13";
const EXAMS_PANEL_URL = "/ghc-control-center?tab=examenes";
  ...
  return (
    <main className="blueprint-page">
      ...
      <aside className="blueprint-sidebar">
        <div>
          <button type="button" className="back-link" onClick={() => router.push(EXAMS_PANEL_URL)}>
            ← Volver a Exámenes
          </button>
        ...
        <form className="blueprint-layout" onSubmit={handleSubmit} noValidate>
          ...
          <aside className="summary-column">
            <article className="summary-card">
              ...
              <button type="button" className="secondary-action" onClick={() => router.push(EXAMS_PANEL_URL)}>
                Volver a Exámenes
              </button>
            </article>
              ...
              <article className="created-card">
                ...
                <div>
                  ...
                  <div className="created-actions">
                    <button
                      type="button"
                      onClick={() => router.push(`/ghc-control-center/examenes/${String(createdBlueprint.id || "")}`)}
                    >
                      Abrir gestión
                    </button>
                    <button type="button" onClick={() => router.push(EXAMS_PANEL_URL)}>
                      Volver a Exámenes
                    </button>
                  </div>
                </div>
