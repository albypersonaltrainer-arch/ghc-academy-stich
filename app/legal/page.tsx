    ...
    <main className={styles.page}>
      ...
      <article className={styles.document}>
        ...
        <section id="pagos">
          ...
          <p>La política ordinaria de GHC Academy permite como máximo cuatro pagos. El número de pagos y el precio total de cada modalidad dependen del producto y de la oferta vigente. Cuando una modalidad fraccionada tenga un precio total distinto del pago único, esa diferencia se mostrará expresamente antes de contratar junto con los importes y vencimientos. No se aplicarán recargos no informados. Si en el futuro se ofrece financiación sometida a regulación específica, se utilizará únicamente cuando el marco jurídico aplicable lo permita y, cuando proceda, mediante un proveedor financiero externo autorizado, con su información precontractual propia.</p>
